  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        setProduct(res.data);
        setCreator(res.data.product_shop);
        setRating(res.data.rating || 0);

        const resRating = await axios.get(
          `${ROUTES.BE}/api/reviews/rating/${product_id}`,
          {
            headers: {
              Authorization: "Bearer " + token,
            },
        ...
        <div className="md:w-1/2 md:ml-8 mt-6 md:mt-0">
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: formatDescription(product.product_description),
            }}
          />
          ...
          <div className="mb-4 flex items-center">
            <img
              ...
              src={creator.image || "https://cellphones.com.vn/sforum/wp-content/uploads/2023/10/avatar-trang-4.jpg"}
              alt={creator.name || "Creator"}
              onError={(e) => {
                e.target.src = "https://cellphones.com.vn/sforum/wp-content/uploads/2023/10/avatar-trang-4.jpg"; 
              }}
            />
            <div>
          ...
          <div className="flex items-center mb-4">
            <p className="flex flex-row text-lg font-semibold mr-4">
              Overall rating:
