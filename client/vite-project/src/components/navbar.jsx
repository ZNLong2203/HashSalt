...
const Navbar = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 flex items-center justify-between p-6 bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 text-white ">
            <div className="text-2xl font-bold" onClick={() => navigate(ROUTES.HOME)}>HashSalt</div>
